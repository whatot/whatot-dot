...
(setq org-roam-capture-templates
      '(
        ...
        ("b" "book notes" plain "%?"
         ...
         :unnarrowed t)
        ("a" "algorithm" plain "%?"
         :target (file+head "algorithm/algorithm%<%Y%m%d%H>-${slug}.org"
                            "#+title: ${title}\n#+filetags: :algorithm: \n\n")
         :unnarrowed t)
        ("d" "data science" plain "%?"
         :target (file+head "data/data%<%Y%m%d%H>-${slug}.org"
                            "#+title: ${title}\n#+filetags: :data: \n\n")
         :unnarrowed t)
        ("e" "engineering" plain "%?"
         :target (file+head "engineering/engineering%<%Y%m%d%H>-${slug}.org"
